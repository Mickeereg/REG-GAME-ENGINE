...
if __name__ == "__main__":
    reg = Reg("PlatformerController2D", bg_color = "cyan")

    player = PlatformerController2D(reg, x = 0, y = 0, centered = True)

    ground = GameObject(reg, "rect", width = 5000, height = 100, x = 0, y = 500, color = "gray")
    ground.center_x()
