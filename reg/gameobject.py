...
class GameObject(pygame.Rect):
    ...
    def collide(self, rect):
        try:
            ...
            raise AttributeError("regError: sorry but when you typed collide(object), the object wasnt a GameObject or a list of GameObjects. see you soon :)")
...
if __name__ == "__main__":
    ...
    demo = GameObject(reg, shape = "ellipse", width = 20, height = 20, x = 0, y = 0, color = "red")
    demo.center()
