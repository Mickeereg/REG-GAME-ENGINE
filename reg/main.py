...
class Reg:
    def __init__(self, title = "reg", width = 800, height = 600, bg_color = (0, 0, 0)):
        self.width = width
        self.height = height
        self.title = title
        ...
        self.icon = os.path.join(path, "./assets/reg.png")
...
if __name__ == "__main__":
    ...
    reg = Reg("Reg!", width = 800, height = 600, bg_color = (0, 0, 0))
